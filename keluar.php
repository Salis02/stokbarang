                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Rincian Barang Keluar</li>
                        </ol>
                        <div class="row">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="penerima" placeholder="Penerima" class="form-control" id="recipient-name" required></br>
                                    ...
                                    <?php
                                            ...
                                            while ($data = mysqli_fetch_array($ambilsemuadatastock)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $penerima;?></td>
                                                    <td>
                                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $idk;?>" data-bs-whatever="@mdo">Edit</button>
                                                ...
                                                <div class="modal fade" id="edit<?= $idk;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post">
                                                            ...
                                                            <input type="text" name="penerima" value="<?= $penerima;?>" class="form-control" id="recipient-name" required></br>
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $idk;?>" data-bs-whatever="@mdo">Hapus</button>
